...
class Registration(models.Model):
    ...
    parents_permit = models.FileField("Parent's Permit",
        upload_to=permit_upload_path)
    parent_contact_number = models.CharField("Parent's Contact Number",
        max_length=20)
    datetime_registered = models.DateTimeField("Date Registered",
        auto_now_add = True)
